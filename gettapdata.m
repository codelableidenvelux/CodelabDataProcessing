function [tmp_Data] = gettapdata(var, working_dir)
...
% length(Data)
% [Data] = gettapdata(var, working_dir), use gettapdatamac if on a mac or
% linux machine 
...
% onset 
% Arko Ghosh, Leiden University, 22/02/2018 updated 11/06/2020
